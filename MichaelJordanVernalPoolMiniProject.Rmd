...
To estimate whether a pool would benefit from certification, I evaluated its proximity to wetlands, since this defines WPA jurisdiction. First, I determined which potential pool points fell within the boundary of a wetland polygon. Of the `r nrow(potential.pools)`, `r sum(potential.pools$within.wetland)` fell within a wetland. For the remaining pools, I determined the distance from nearest wetland polygon.
