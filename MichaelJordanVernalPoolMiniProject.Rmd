...
```{r result_map, echo=FALSE, fig.align='center', out.width="75%", out.height="75%", error=FALSE, warning=FALSE, message=FALSE}
...
```{r result_table, echo=FALSE, fig.align='center', out.width="75%", out.height="75%", error=FALSE, warning=FALSE, message=FALSE}
