...
To determine which potential pools were likely to benefit from certification, I evaluated each pool's proximity to a wetland. Pool points that were inside of a wetland or within 150 feet of the nearest wetland were deemed to be candidates for certification. `r nrow(cm.pp[cm.pp$dtw <= 100, ])`potential pools or `r scales::percent(round(nrow(worcester.pp.f) / nrow(worcester.pp), digits = 2))` of pools in the county passed this threshold.
